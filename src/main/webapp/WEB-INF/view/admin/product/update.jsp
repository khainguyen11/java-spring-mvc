                                            ...
                                            <form:form method="post" action="/admin/product/update" class="row"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <form:textarea
                                                        ...
                                                        id="exampleFormControlTextarea1" rows="3" path="detailDesc" />
                                                ...
                                                <div class="mb-3 col-12 col-md-6">
                                                    ...
                                                    <form:input type="number"
                                                        ...
                                                        path="quantity" min="0" max="100" step="1" />
                                                    ${errorQuantity}
                                                </div>
                                                <div class="mb-3 col-12 col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" type="file" id="avatarFile"
                                                        accept=".png, .jpg, .jepg, .png" name="productFile" />
                                                </div>
                                                <div class="col-12 mb-3">

                                                    <c:set var="setImage" value="${newProduct.image}" />
                                                    <c:if test="${not empty setImage}">
